...
"""
    ...
    Version history: 
        ...
        Updated  on Tue Apr 20 16:00:00 2021 (Version 3.0) (Distribution 1)
"""
...
Memory={'1001000000000000':'0000000000110000',
        '1001000000000001':'0000000000111000',
        '1001000000000010':'0000000000110000',
        '1001000000000011':'0000000001110000',
        '1001000000000100':'0000000010110000',
        '1001000000000101':'0000000000110100',
        '1001000000000110':'0000000000110000',
        '1001000000000111':'0000000000000000'}
PC ='0000010010010100'
IR ='1011000110101110'
        ...
        if trapVect=='00100000':
            ...
            while True:
                ...
                if data!='0000000000000000':
                    ...
                    break
                pointer=ALU_ADDer(pointer,'0000000000000001')
            print()
    ...
    while True:
        ...
        if command=='0000000000000000':
            ...
            if operating==False:
                ...
                break
        globals()['PC']=ALU_ADDer(globals()['PC'],'0000000000000001')
        globals()['command_count']+=1
        if stepwise==True:
            printStatus()
